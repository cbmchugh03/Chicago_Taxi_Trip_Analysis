# Chicago Taxi Trip Data Analysis


## Overview

This project analyzes **Chicago taxi trip data** to provide actionable
insights for taxi companies. The goal is to help optimize operations,
including:
...
locations. Because the analysis uses Big Query through Google Colab, the
project can only be done in Google Colab.

------------------------------------------------------------------------

## Why This Project Matters

Taxi companies need data-driven insights to improve profitability and
customer satisfaction. By analyzing **trip patterns, fare trends, and
customer payment behaviors**, companies can:
...
The analysis identifies which hours yield **highest fares and tips**,
helping companies schedule drivers effectively.
...
Mapping community area codes to neighborhood names identifies
high-demand areas.
...
- Suburban areas still contribute significantly, indicating **growth
  potential**
...
Objective: **Predict likelihood of a trip receiving a tip based on trip
features.**
...
- Negative predictors: Cash payments, very short trips, unknown payment
  types
...
- Company-Specific Strategies
  - Some companies correlate with specific payment types → potential for
    targeted marketing
...
- Concentrate fleets in high-demand neighborhoods but do not ignore
  suburban areas
...
**Connor McHugh** **Date:** April 29th, 2025  
